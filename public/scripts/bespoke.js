    ...
    var c = function(b, c) {
        var h = 1 === b.nodeType ? b : document.querySelector(b)
          ...
          , m = function(a, b) {
            var c = b - i.indexOf(j)
              , d = c > 0 ? "after" : "before";
            ["before(-\\d+)?", "after(-\\d+)?", "active", "inactive"].map(g.bind(null , a)),
            a !== j && ["inactive", d, d + "-" + Math.abs(c)].map(f.bind(null , a))
        }
          , n = function(a, b) {
...
bespoke.plugins.keys = function(a, b) {
    var c = b === !0 || "horizontal" == b;
    document.addEventListener("keydown", function(b) {
        (34 == b.which || 32 == b.which || c && 39 == b.which || !c && 40 == b.which) && a.next(),
        (33 == b.which || c && 37 == b.which || !c && 38 == b.which) && a.prev()
    })
}
,
...
function(a) {
    a.plugins.bullets = function(a, b) {
        var c, d, e = a.slides.map(function(a) {
            ...
            var a = c - 1;
            return i(-1) ? (h(c, d - 1),
            !1) : void (e[a] && h(a, e[a].length - 1))
        }, h = function(a, b) {
            c = a,
            d = b,
            e.forEach(function(c, d) {
                c.forEach(function(c, e) {
                    c.classList.add("bespoke-bullet"),
                    a > d || d === a && b >= e ? (c.classList.add("bespoke-bullet-active"),
                    c.classList.remove("bespoke-bullet-inactive")) : (c.classList.add("bespoke-bullet-inactive"),
                    c.classList.remove("bespoke-bullet-active"))
                })
            })
        }, i = function(a) {
...
!function(a) {
    a.plugins.scale = function(a, b) {
        var c = a.parent
          ...
          , e = d.offsetHeight
          , f = d.offsetWidth
          , g = "zoom" === b || "zoom"in c.style && "transform" !== b
          , h = function(a) {
            var b = document.createElement("div");
            return b.className = "bespoke-scale-parent",
            c.insertBefore(b, a),
            b.appendChild(a),
            b
        }
          , i = g ? a.slides : a.slides.map(h)
          , j = function(a) {
...
function(a) {
    a.plugins.hash = function(a) {
        ...
        setTimeout(function() {
            c(),
            a.on("activate", function(a) {
                var c = a.slide.getAttribute("data-bespoke-hash");
                window.location.hash = c || a.index + 1,
                b = a.index
            }),
...
!function(a) {
    a.plugins.progress = function(a, b) {
        var c = document.createElement("div")
          ...
          , e = "vertical" === b ? "height" : ["horizontal", !0].indexOf(b) + 1 ? "width" : void 0;
        e && (c.className = "bespoke-progress-parent",
        d.className = "bespoke-progress-bar",
        c.appendChild(d),
...
function(a) {
    a.plugins.state = function(a) {
        ...
        a.on("activate", b.bind(null , "add")),
        a.on("deactivate", b.bind(null , "remove"))
    }
}(bespoke),
function() {
    ...
    if (self.Prism && self.document && document.querySelector) {
        ...
        Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function(b) {
            ...
            g.onreadystatechange = function() {
                4 == g.readyState && (g.status < 400 && g.responseText ? (f.textContent = g.responseText,
                Prism.highlightElement(f)) : f.textContent = g.status >= 400 ? "✖ Error " + g.status + " while fetching file: " + g.statusText : "✖ Error: File does not exist or is empty")
            }
            ,
            g.send(null )
        })
...
deck.on('activate', function(event) {
    /* Backgrounds */
    if (event.slide.id === 'introduction-1') {
        document.body.style.backgroundImage = 'url("images/background-syria.png")';
    } else if (event.slide.id === 'final') {
        document.body.style.backgroundImage = 'url("images/unhcr_smartphone_refugees.jpg")';
    } else if (document.body.style.backgroundImage != '') {
        document.body.style.backgroundImage = '';
    }

    /* Charts */
    if (event.slide.id === 'data-1') {
        new Chartist.Bar('.ct-chart-syrian-occupations', {
                labels: ['Managers', 'Professionals', 'Technicians', 'Clerks', 'Service-Workers', 'Skilled-Workers', 'Craft', 'Plant-Operators', 'Elementary'],
                series: [[90, 600, 259, 315, 730, 560, 146, 614, 578]]
            }, {
                seriesBarDistance: 40,
            }
        );
    } else if (event.slide.id === 'data-2') {
        new Chartist.Bar('.ct-chart-european-demand', {
                labels: ['Austria', 'Belgium', 'Bulgaria', 'Croatia', 'Cyprus', 'Czech-Republic', 'Denmark', 'Estonia', 'Finland', 'France',
                    'Germany', 'Greece', 'Hungary', 'Ireland', 'Italy', 'Latvia', 'Lithuania', 'Luxembourg', 'Malta', 'Netherlands',
                    'Poland', 'Portugal', 'Romania', 'Slovakia', 'Slovenia', 'Spain', 'Sweden', 'United-Kingdom'],
                series: [[4192, 4656, 2000, 2768, 624, 4768, 0, 2816, 2752, 22672, 29472, 3040, 2864, 0, 18944, 1936, 1856, 1360, 1104, 6960, 9024, 6224, 6000, 2848, 1840, 14560, 4672, 0]]
            }, {
    ...
    } else if (event.slide.id === 'analysis-1') {
        new Chartist.Line('.ct-chart-analysis-1', {
                labels: ['Managers', 'Professionals', 'Technicians', 'Clerks', 'Service-Workers', 'Skilled-Workers', 'Craft', 'Plant-Operators', 'Elementary'],
                series: [[13691, 32368, 24602, 10614, 21542, 9062, 14778, 14778, 18253]]
            }, {
                low: 0,
                showArea: true
            }
        ...
        new Chartist.Line('.ct-chart-analysis-2', {
                labels: ['Managers', 'Professionals', 'Technicians', 'Clerks', 'Service-Workers', 'Skilled-Workers', 'Craft', 'Plant-Operators', 'Elementary'],
                series: [[9089300, 20107300, 16999000, 7400100, 12920300, 5693700, 7387300, 7387300, 11813600]]
            }, {
                low: 0,
                showArea: true
            }
        );
    } else if (event.slide.id === 'analysis-2') {
        new Chartist.Line('.ct-chart-analysis-3', {
                labels: ['Managers', 'Professionals', 'Technicians', 'Clerks', 'Service-Workers', 'Skilled-Workers', 'Craft', 'Plant-Operators', 'Elementary'],
                series: [[90092, 323795, 246129, 106227, 215511, 90734, 147897, 147897, 182902]]
            }, {
                low: 0,
                showArea: true
            }
        ...
        new Chartist.Line('.ct-chart-analysis-4', {
                labels: ['Managers', 'Professionals', 'Technicians', 'Clerks', 'Service-Workers', 'Skilled-Workers', 'Craft', 'Plant-Operators', 'Elementary'],
                series: [[9089300, 20107300, 16999000, 7400100, 12920300, 5693700, 7387300, 7387300, 11813600]]
            }, {
                low: 0,
    ...
    } else if (event.slide.id === 'analysis-3') {
        new Chartist.Bar('.ct-chart-analysis-5', {
                labels: ['Austria', 'Belgium', 'Bulgaria', 'Croatia', 'Cyprus', 'Czech-Republic', 'Denmark', 'Estonia', 'Finland', 'France',
                    'Germany', 'Greece', 'Hungary', 'Ireland', 'Italy', 'Latvia', 'Lithuania', 'Luxembourg', 'Malta', 'Netherlands',
                    'Poland', 'Portugal', 'Romania', 'Slovakia', 'Slovenia', 'Spain', 'Sweden', 'United-Kingdom'],
                series: [[0.2147, 0.0215, 0.1000, 0.2890, 0.4808, 0.0000, 0.3551, 0.1817, 0.0221, 0.2104, 0.2961, 0.0000, 0.0000, 0.3616, 0.2694, 0.2941, 0.2717, 1.4655, 0.0000, 0.0964, 0.0000, 0.2458, 0.1630, 0.0206, 0.2140]]
            }
        );
    } else if (event.slide.id === 'analysis-4') {
        new Chartist.Bar('.ct-chart-analysis-6', {
                labels: ['Austria', 'Belgium', 'Bulgaria', 'Croatia', 'Cyprus', 'Czech-Republic', 'Denmark', 'Estonia', 'Finland', 'France',
                    'Germany', 'Greece', 'Hungary', 'Ireland', 'Italy', 'Latvia', 'Lithuania', 'Luxembourg', 'Malta', 'Netherlands',
                    'Poland', 'Portugal', 'Romania', 'Slovakia', 'Slovenia', 'Spain', 'Sweden', 'United-Kingdom'],
                series: [[0.1050, 0.0000, 0.1000, 0.1192, 0.0000, 0.0000, 0.2166, 0.0145, 0.0022, 0.2019, 0.1118, 0.0000, 0.0000, 0.1240, 0.0162, 0.1103, 0.0000, 2.1451, 6.9393, 12.1048, 11.2000, 1.4150, 8.1196, 13.6016, 8.1079]]
            }
        );
    }
